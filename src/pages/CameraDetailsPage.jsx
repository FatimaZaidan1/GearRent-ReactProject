...
import cameraData from '../data/cameraData'; // 👈 Adjust path as needed
...
const CameraDetailsPage = () => {
    ...
    useEffect(() => {
        // Find the camera by ID (The ID from useParams is a string, so we convert the data ID to string for comparison)
    ...
    // Set today's date for minimum date input value
    const today = new Date().toISOString().split('T')[0];

    return (
        <div className="container mx-auto px-4 py-8 max-w-7xl">
            <NavLink to="/cameras" className="text-gray-500 hover:text-[#FF8C00] transition duration-200 flex items-center mb-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-2">
                    ...
                    {/* Camera Title and Short Description */}
                ...
                {/* Right Column: Booking Widget (Matches Screenshot Style) */}
                <div className="lg:col-span-1">
                    <div className="bg-white p-6 rounded-xl shadow-xl border border-gray-100">
                        ...
                        <form onSubmit={handleBookingSubmit} className="space-y-4">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    onChange={(e) => {
                                        ...
                                        setBookingMessage(''); // Clear message on change
                                    }}
                                    min={today}
                            ...
                            {/* Booking Button (Styled to your Navbar's orange) */}
                            <button
                                type="submit"
                            ...
                            {/* Booking Status/Info */}
                            {bookingMessage ? (
                                <p className={`text-center font-medium ${bookingMessage.includes('confirmed') ? 'text-green-600' : 'text-red-500'} pt-2`}>
                                    {bookingMessage}
                                </p>
                            ) : (
